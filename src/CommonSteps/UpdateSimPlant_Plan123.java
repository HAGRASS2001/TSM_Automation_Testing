...
public class UpdateSimPlant_Plan123  {
	
	WebDriver driver;
	int balance;
	int bundle;
	
	public UpdateSimPlant_Plan123(WebDriver driver, int balance, int bundle) {
		this.driver = driver;
	...
	public void UpdatePlan123() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[1]/div/table/thead/tr/th[1]")).click();
		...
		//Enter name value
		driver.findElement(By.xpath("//*[@id=\"sim_plan-CreditCheckCommand\"]")).sendKeys("your credit is $"+ balance +"and, your bundle is "+ bundle +"mins");
		//click on save
