...
public class AddBundleAndCreditCheck {
	public static void main(String[] args) throws InterruptedException, JsonMappingException, JsonProcessingException {
		...
		UpdateSimPlant_Plan123 UpdatePlan123 = new UpdateSimPlant_Plan123(driver, 350, 450);
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[20]/div/div/div/div/select/option[6]")).click();
		...
		//get job name
		String jobname = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[20]/td[2]")).getText();
        ...
        String json = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[2]/td[5]/div/div/div/div[2]"))
        		.findElement(By.tagName("textarea")).getAttribute("value");

		ObjectMapper objectMapper = new ObjectMapper();
		JsonNode rootNode = objectMapper.readTree(json);
		JsonNode simAfter = rootNode.get("simAfter");
		String BundleBalanceFromJson = simAfter.get("bundle_balance").asText();
		try {
			//click on close data
			driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[2]/td[5]/div/div/div/div[1]/button")).click();
			driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[2]/td[5]/div/div/div/div[1]/button")).click();
		} catch (Exception e) {
        ...
        String json2 = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[2]"))
        		.findElement(By.tagName("textarea")).getAttribute("value");

		ObjectMapper objectMapper2 = new ObjectMapper();
		JsonNode rootNode2 = objectMapper2.readTree(json2);
		JsonNode simAfter2 = rootNode2.get("simAfter");
		String BalanceFromJson = simAfter2.get("balance").asText();
		
		//click on close data
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[1]/button")).click();
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[1]/button")).click();
...
Thread.sleep(5000);		
		...
		String BundleBalance = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[10]")).getText();
		//get balance from table
		String Balance = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[12]")).getText();
        ...
        String jobID = rootNode3.get("jobId").asText();
        
        //get the json for first job
        String jobMonitorJson2 = driver.findElement(By.xpath("/html/body/div/div/main/div[4]/div[2]/table/tbody/tr[4]/td/div/pre")).getText();
        JsonNode rootNode4 = objectMapper.readTree(jobMonitorJson2);
        String jobID2 = rootNode4.get("jobId").asText();
      ...
      //login to strapi
        ...
        String jobtype2 = "";
        String jobStatus2 = "";
        String JobRunningMode2 = "";
        String jobid2 = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/main/div[3]/div[1]/div/div/table/tbody/tr[2]/td[2]/span")).getText().replaceAll(",", "");
        if(jobid2.equals(jobID2)) {
        	jobtype2 = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/main/div[3]/div[1]/div/div/table/tbody/tr[2]/td[3]")).getText();
        	jobStatus2 = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/main/div[3]/div[1]/div/div/table/tbody/tr[2]/td[4]")).getText();
        	JobRunningMode2 = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div/main/div[3]/div[1]/div/div/table/tbody/tr[2]/td[5]")).getText();
        }
		...
		if(BundleBalance.equals("450") & Balance.equals("350") & BalanceFromJson.equals("350") & BundleBalanceFromJson.equals("450")
