...
public class CreditCheckOnly {
	public static void main(String[] args) throws InterruptedException, JsonMappingException, JsonProcessingException {
		...
		UpdateSimPlant_Plan123 UpdatePlan123 = new UpdateSimPlant_Plan123(driver, 600, 500);
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[20]/div/div/div/div/select/option[4]")).click();
        ...
        String balanceFromJson = simBefore.get("balance").asText();
        ...
        System.out.println(BundleBalance + Balance + balanceFromJson + BundleBalanceFromJson + jobtype + jobStatus + JobRunningMode + jobID + simID);
