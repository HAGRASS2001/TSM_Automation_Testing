...
public class ReCredit_CreditCheck {
	public static void main(String[] args) throws InterruptedException, JsonMappingException, JsonProcessingException {
		...
		//select Recredit + credit check action
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[20]/div/div/div/div/select/option[8]")).click();
		...
		//click on show data
		//driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[5]/button")).click();
		
        
        //close the data
        //driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[5]/div/div/div/div[3]/button")).click();
        //driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[5]/div/div/div/div[3]/button")).click();
		...
		String BundleBalanceForCreditCheck = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[10]")).getText();
		//get balance from table
		String BalanceForCreditCheck = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[12]")).getText();
		...
		String jobname = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[3]/label/select/option[2]")).getText();
		...
		String json2 = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[2]/td[5]/div/div/div/div[2]"))
		...
		//balance
		//click on show data
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/button")).click();
		
        String json = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[2]"))
        		.findElement(By.tagName("textarea")).getAttribute("value");
		try {
        //close data
        driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[3]/button")).click();
        driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[3]/button")).click();
		} catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        }
        ...
        //for Credit check ********************************************
        JsonNode rootNodeForCreditCheck = objectMapper.readTree(json);

        JsonNode simBefore = rootNodeForCreditCheck.get("simBefore");
        String Simid = simBefore.get("id").asText();
        JsonNode simAfterForCreditCheck = rootNodeForCreditCheck.get("simAfter");
        String balanceFromJsonForCreditCheck = simAfterForCreditCheck.get("balance").asText();

        JsonNode rootNodeForCreditCheck2 = objectMapper.readTree(json2);
        JsonNode simAfterForCreditCheck2 = rootNodeForCreditCheck2.get("simAfter");
        String BundleBalanceFromJson = simAfterForCreditCheck2.get("bundle_balance").asText();
        //*************************************************************
        ...
        String jobID = rootNode2.get("jobId").asText();
        String simID = rootNode2.get("DataTypeId").asText();
        ...
        System.out.println( balanceFromJsonForCreditCheck  + " " + BundleBalanceFromJson + " " + BalanceForCreditCheck + " " + BundleBalanceForCreditCheck + " " + 
        		jobtype + " " + jobStatus + " " + JobRunningMode + " " + jobID + " " + simID + "--------------" + jobid + " " + Simid);
		//check if the IMEI and IMSI same as the input
		if((balanceFromJsonForCreditCheck.equals(BalanceForCreditCheck) & BundleBalanceFromJson.equals(BundleBalanceForCreditCheck)) 
