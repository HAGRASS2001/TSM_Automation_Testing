...
public class AddbundleOnlyNG {
  ...
  public void AddbundleOnlyNG() throws InterruptedException, JsonMappingException, JsonProcessingException {
		...
		//get job name
		jobname = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[7]/td[2]")).getText();
      ...
      jobID = rootNode.get("jobId").asText();
