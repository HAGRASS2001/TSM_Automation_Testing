...
public class CreateNewSimNG {
	...
	public void CreateNewSimNG() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"sims-imsi\"]")).sendKeys("2010309");
		// select IMEI input
		driver.findElement(By.xpath("//*[@id=\"sims-imei\"]")).click();
		// enter the IMEI value
		driver.findElement(By.xpath("//*[@id=\"sims-imei\"]")).sendKeys("2010309");
		// select Subscriber num input
		driver.findElement(By.xpath("//*[@id=\"sims-subscriber_num\"]")).click();
		// enter the Subscriber num value
		driver.findElement(By.xpath("//*[@id=\"sims-subscriber_num\"]")).sendKeys("2010309");
		...
		driver.findElement(By.xpath("//*[@id=\"sims-IQSIM_Value\"]")).sendKeys("2010309");
	...
	public void afterMethod() {
		...
		if(IMEI.equals("2010309") & IMSI.equals("2010309")) {
