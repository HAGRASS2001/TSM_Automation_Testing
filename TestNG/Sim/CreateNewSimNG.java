...
public class CreateNewSimNG {
	...
	public void CreateNewSimNG() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"sims-imsi\"]")).sendKeys("909080087070");
		// select IMEI input
		driver.findElement(By.xpath("//*[@id=\"sims-imei\"]")).click();
		// enter the IMEI value
		driver.findElement(By.xpath("//*[@id=\"sims-imei\"]")).sendKeys("909080087070");
		// select Subscriber num input
		driver.findElement(By.xpath("//*[@id=\"sims-subscriber_num\"]")).click();
		// enter the Subscriber num value
		driver.findElement(By.xpath("//*[@id=\"sims-subscriber_num\"]")).sendKeys("909080087070");
		...
		driver.findElement(By.xpath("//*[@id=\"sims-IQSIM_Value\"]")).sendKeys("909080087070");
	...
	public void afterMethod() {
		...
		if(IMEI.equals("909080087070") & IMSI.equals("909080087070")) {
