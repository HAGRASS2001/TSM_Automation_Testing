...
public class ReCredit_CreditCheckNG {
	...
	private String BundleBalanceForCreditCheck = "";
	private String BalanceForCreditCheck = "";
	private String jobname = "";
	private String json2 = "";
	private String balanceFromJsonForCreditCheck = "";
	private String BundleBalanceFromJson = "";

	@Test
	public void ReCredit_CreditCheckNG() throws InterruptedException, JsonMappingException, JsonProcessingException {
		...
		driver.findElement(By.xpath(
				"/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[20]/div/div/div/div/select/option[8]"))
				.click();
		...
		BundleBalanceForCreditCheck = driver.findElement(By.xpath(
		...
		BalanceForCreditCheck = driver.findElement(By.xpath(
		...
		try {
			// close data
			driver.findElement(By.xpath(
					"/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[3]/button"))
					.click();
			driver.findElement(By.xpath(
					"/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[8]/td[5]/div/div/div/div[3]/button"))
					.click();
		...
		balanceFromJsonForCreditCheck = simAfterForCreditCheck.get("balance").asText();
		...
		BundleBalanceFromJson = simAfterForCreditCheck2.get("bundle_balance").asText();
		// *************************************************************
	...
	public void afterMethod() {
		...
		System.out.println(balanceFromJsonForCreditCheck + " " + BundleBalanceFromJson + " " + BalanceForCreditCheck
				+ " " + BundleBalanceForCreditCheck + " " + jobtype + " " + jobStatus + " " + JobRunningMode + " "
				+ jobID + " " + simID + "--------------" + jobid + " " + Simid);
		// check if the IMEI and IMSI same as the input
		if ((balanceFromJsonForCreditCheck.equals(BalanceForCreditCheck)
				& BundleBalanceFromJson.equals(BundleBalanceForCreditCheck))
