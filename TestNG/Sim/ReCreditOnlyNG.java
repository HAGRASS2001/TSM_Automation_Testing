...
public class ReCreditOnlyNG {
	...
	private int balanceFromJson = 0;
	private int Balance2;
	@Test
  public void ReCreditOnlyNG() throws InterruptedException, JsonMappingException, JsonProcessingException {
		...
		//balance before edit
		Balance2 = Integer.parseInt(driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[12]")).getText());
		...
		Balance = Integer.parseInt(driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[12]")).getText());
      ...
      json = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[5]/div[2]/table/tbody/tr[1]/td[5]/div/div/div/div[2]"))
      ...
      balanceFromJson  = simAfter.get("balance").asInt();
